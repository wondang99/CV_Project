...
for epoch in range(num_epochs):
    ...
    for i,(images,target) in enumerate(train_loader):
        # print("\n","For testloader test : ",target.shape,"\n")
        ...
        pred = net(images)
        # print("\n","For criterion test : ",pred.shape,"\n")
        # print("\n","For critertion test : ",target.shape,"\n")
    ...
    with torch.no_grad():
        ...
        if best_test_loss > validation_loss:
            ...
            torch.save(net.state_dict(),'best_100.pth')
        logfile.writelines(str(epoch) + '\t' + str(validation_loss) + '\n')  
        logfile.flush()      
        torch.save(net.state_dict(),'yolo_100.pth')
